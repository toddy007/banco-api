...
export const passwordDefault = z
    ...
    .regex(
        ...
        'Password must contain at least 2 uppercase letters, 4 numbers, 1 symbol and no spaces',
    );
...
export const usernameDefault = z
    ...
    .regex(
        ...
        "Username must contain only letters and spaces; you can't use spaces in the start and at the end; you can't use space followed by another",
    );
